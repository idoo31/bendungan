...
<head>
    ...
    <style>
        ...
        @media (min-width: 640px) {
            .kontak-hero-bg { min-height: 180px; }
        }
        @media (min-width: 1024px) {
            .kontak-hero-bg { min-height: 220px; }
        }

        /* Navbar Style (Sama seperti halaman lain) */
        .navbar {
    ...
    <nav id="navbar" class="navbar fixed top-0 left-0 z-50 flex h-[80px] w-full items-center text-white">
        <div class="container mx-auto flex h-full items-center justify-between px-6">
            ...
            <div class="hidden space-x-8 text-base font-medium md:flex">
                ...
                <a href="#footer" class="text-yellow-300 border-b-2 border-yellow-300 pb-1">Kontak</a>
            </div>
        ...
        <div id="mobile-menu" class="absolute left-0 top-[80px] z-40 hidden w-full bg-[#223333] px-6 py-4 md:hidden">
            ...
            <a href="#footer" class="block py-2 text-yellow-300">Kontak</a>
        </div>
    </nav>
                ...
                <div class="bg-white p-8 rounded-lg shadow-lg border border-gray-200">
                    ...
                    <form action="#" method="POST" class="space-y-5">
                        <div>
                            ...
                            <input type="text" name="nama" id="nama" required class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#0077b6] focus:border-transparent transition">
                        </div>
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Alamat Email</label>
                            <input type="email" name="email" id="email" required class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#0077b6] focus:border-transparent transition">
                        </div>
                        <div>
                            <label for="subjek" class="block text-sm font-medium text-gray-700 mb-1">Subjek</label>
                            <input type="text" name="subjek" id="subjek" required class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#0077b6] focus:border-transparent transition">
                        </div>
                        <div>
                            <label for="pesan" class="block text-sm font-medium text-gray-700 mb-1">Pesan Anda</label>
                            <textarea name="pesan" id="pesan" rows="5" required class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#0077b6] focus:border-transparent transition"></textarea>
                        </div>
                        <div>
    ...
    <section class="pb-16">
         <div class="container mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <div class="overflow-hidden rounded-lg shadow-lg">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.037380537443!2d106.8485253153495!3d-6.642131995195007!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c894a4574c81%3A0x8543564033b9347!2sSDN%20Bendungan%201!5e0!3m2!1sen!2sid!4v1663333333333!5m2!1sen!2sid" 
                    width="100%" 
                    height="400" 
                    style="border:0;" 
                    allowfullscreen="" 
